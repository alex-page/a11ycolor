...
// Local
// -------------------------------------------------------------------------------------------------------------------------------------------------------------
const CheckColor  = require( '../src/color' ).CheckColor;
const GetContrast = require( '../src/color' ).GetContrast;
const GetHex      = require( '../src/color' ).GetHex;
const GetHsl      = require( '../src/color' ).GetHsl;
